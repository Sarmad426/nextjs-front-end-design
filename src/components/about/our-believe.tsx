export const OurBelieve = () => {
  ...
  return (
    <section className="w-full md:w-[95%] mx-auto my-12">
      <div>
        <div className="flex flex-col gap-4 lg:flex-row lg:justify-evenly items-start lg:items-center mx-4 my-6">
        ...
        <div className={cardsDivStyles}>
          <div className="flex flex-col lg:max-w-[48%] bg-[#FAF5E2] p-3 md:p-[40px] w-full h-[330px] lg:h-[360px] gap-[20px] justify-between relative group">
            ...
            <p className="md:text-[18px] leading-[24px] text-[#202020b3] font-300">
          ...
          <div className="flex flex-col w-full lg:max-w-[48%] bg-[#FAF5E2] p-3 md:p-[40px] h-min lg:h-[360px] gap-[20px] justify-between relative group">
            <div className="absolute left-0 top-0 bottom-0 w-[4px] h-full bg-[#43AA13] opacity-0 transition-all duration-[.3s] group-hover:opacity-100" />
            <h3 className=" text-[24px] lg:text-[32px] font-500 uppercase text-[#193E2C]">
              Personal Mentorship
            </h3>
